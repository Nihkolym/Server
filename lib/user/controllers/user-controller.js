...
module.exports = class UserController{
    ...
    static async postUser(req, res){
        try {
            ...
            // let transport = await MailService.getUserTransport();
            
            // MailService.sendMail(transport, {
            //     from: '565189@gmail.com', 
            //     to: '565189@gmail.com', 
            //     subject: 'Hello ✔', 
            //     text: 'Hello world', 
            //     html: `<b>Hello world i'm ${user.firstname} ${user.lastname}</b>` 
            // });
